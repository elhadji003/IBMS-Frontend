...
import CoursProgrammationPyt from "./CoursProgrammationPyt";
import CoursBureautiquePyt from "./CoursBureautiquePyt";

export default function TabsCoursPyt() {
